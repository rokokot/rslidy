// Rslidy version 2.0.0 UMD
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory();
	else if(typeof define === 'function' && define.amd)
		define("Rslidy", [], factory);
	else if(typeof exports === 'object')
		exports["Rslidy"] = factory();
	else
		root["Rslidy"] = factory();
})(self, () => {
...
const sorting_icon = (/* unused pure expression or super */ null && (`<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">  <polygon points="50,0 1,40 99,40" fill="none" stroke="black" stroke-width="10"/>  <polygon points="50,100 1,60 99,60" fill="none" stroke="black" stroke-width="10"/></svg>`));
const sorting_icon_top = (/* unused pure expression or super */ null && (`<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">  <polygon points="50,0 1,40 99,40" fill="blue" stroke="blue" stroke-width="10"/></svg>`));
const sorting_icon_bottom = (/* unused pure expression or super */ null && (`<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">  <polygon points="50,100 1,60 99,60" fill="blue" stroke="blue" stroke-width="10"/></svg>`));
...
class SettingsComponent {
    ...
    setupTableSorting() {
        ...
        tables.forEach((table) => {
            if (table.classList.contains("rslidy-disable-sorting"))
                return;
                    ...
                    if (newDirection === "none") {
                        ...
                        currentRows.sort((a, b) => {
                            ...
                            // If one is number and one is string, convert both to same type
                                ...
                                if (columnIndex === 8)
                                    console.log(`Mixed comparison (num vs string) result: ${result}`);
                                return result;
                            }
                                ...
                                if (columnIndex === 8)
                                    console.log(`Mixed comparison (string vs num) result: ${result}`);
                                return result;
                            }
                            else {
                                const result = newDirection === "asc"
...
class PrintSettingsComponent {
    ...
    initializeSlideRangeToggle() {
        ...
        const customZoomRadio = this.view.querySelector('#rslidy-checkbox-zoom');
        //const scalingInput =
        // <HTMLInputElement>this.view.querySelector('#custom-scaling-input');
        const zoomInput = this.view.querySelector('#custom-zoom-input');
        ...
        if (selectedOption) {
          ...
          `;
                ...
                case "fit":
                    ...
                    break;
                case "zoom":
                    const zoomValueInput = this.view.querySelector("#custom-zoom-input");
